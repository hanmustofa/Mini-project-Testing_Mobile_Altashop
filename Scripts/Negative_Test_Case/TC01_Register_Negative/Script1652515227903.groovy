...
for (int i = 1; i <= 6; i++) {
    ...
    Mobile.setText(findTestObject('Object_Register/set_text_email'), 'hansa3@email.com', 0)

    Mobile.tap(findTestObject('Object_Register/tap_password'), 0)

    Mobile.setText(findTestObject('Object_Register/set_text_password'), '123123bandung', 0)
