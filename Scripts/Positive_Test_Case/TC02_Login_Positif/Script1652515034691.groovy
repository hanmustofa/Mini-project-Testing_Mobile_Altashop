...
Mobile.setText(findTestObject('Object_Login/set_text_email'), 'hans@email.com', 0)

Mobile.tap(findTestObject('Object_Login/tap_password'), 0)

Mobile.setText(findTestObject('Object_Login/set_text_password'), '123123bandung', 0)
